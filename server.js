...
function metaForPath(routePath) {
  const map = {
    ...
    "/services/security": ["Security Services | Crown Property Management Group Ltd", "Professional security services including guarding, mobile patrols, key holding, construction site security, retail security and event support in Bristol and surrounding areas."],
